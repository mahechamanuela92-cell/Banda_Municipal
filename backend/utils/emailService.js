...
export const enviarCodigoVerificacion = async (emailDestino, nombreDestino, codigo) => {
    try {
        const result = await brevo.transactionalEmails.sendTransacEmail({
            subject: 'Código de verificación - Banda Sinfónica',
            sender: {
                name: process.env.EMAIL_FROM_NAME || 'Banda Sinfónica Municipal',
            ...
            htmlContent: `
                <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 24px; border: 1px solid #f0e6e6; border-radius: 12px; background-color: #ffffff;">
                    <h2 style="color: #d81b60; text-align: center; margin-bottom: 5px;">Banda Sinfónica Municipal</h2>
                    ...
                    <p style="color: #555555; font-size: 15px;">Usa el siguiente código de verificación de 6 dígitos para activar tu cuenta. Este código vencerá en <strong>15 minutos</strong>.</p>
